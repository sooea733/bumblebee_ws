...
typedef struct
{
  ...
  ControlItem heartbeat = {19, RAM, 1, READ_WRITE}; // 로봇의 동작을 확인하기 위한 데이터라고 보자
  ...
  ControlItem lift_flag = {184, RAM, 4, READ_WRITE};
  ControlItem lift_value = {188, RAM, 4, READ_WRITE};
