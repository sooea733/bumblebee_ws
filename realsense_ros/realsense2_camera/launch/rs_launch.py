...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.visual_preset', 'default': '3', 'description': 'Depth module preset [0-5], 3=High Accuracy'},
                           ...
                           {'name': 'align_depth.enable',           'default': 'true', 'description': 'enable align depth filter'},# false
