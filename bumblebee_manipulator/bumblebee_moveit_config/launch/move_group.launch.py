...
def generate_launch_description():
    ...
    robot_description_config = xacro.process_file(
        os.path.join(
            get_package_share_directory("bumblebee_description"),
            "urdf",
    ...
    robot_description_semantic_path = os.path.join(
        get_package_share_directory("bumblebee_moveit_config"),
        "config",
        "bumblebee_manipulator_ver7.srdf",
    )
...
"""
    ...
    # moveit_pose_subscriber_node 실행
...
# move_group 시작 후 5초 뒤 실행
    delayed_node_handler = RegisterEventHandler(
    OnProcessStart(
    ...
    ld.add_action(delayed_node_handler)
